...
التطبيق مجرّد غلاف؛ لا يعمل قبل أن يكون الموقع منشوراً. ثم ضع النطاق في `gradle.properties`:

```properties
madrasaHost=madrasa.dz
```
...
## تغيير النطاق أو الإصدار

```sh
./gradlew bundleRelease -PmadrasaHost=madrasa.dz -PmadrasaVersionName=1.1.0 -PmadrasaVersionCode=2
```

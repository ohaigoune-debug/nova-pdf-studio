...
| إجابة الطالب نص مكتوب كرسالة | تصوير الورقة + OCR | قرار مالك المنصة: التصحيح يكون على نص يكتبه الطالب، فيُصحَّح مباشرة بلا أخطاء تعرّف ضوئي؛ المرفقات داعمة فقط |

...
- [ ] الواجبات + الإسناد (طالب/مجموعة/فوج/أفواج)
- [ ] إجابة الطالب **نصاً مكتوباً كرسالة** داخل المنصة (محرر نص عربي مع حفظ مسودة تلقائي)؛ لا تصوير ولا OCR. المرفقات (صورة/PDF) اختيارية كمواد داعمة فقط ولا تُصحَّح
- [ ] سلسلة رسائل لكل إجابة: إجابة الطالب ← ملاحظة/تصحيح الأستاذ ← ردّ الطالب (تاريخ كامل، لا تعديل للإجابة الأصلية بعد الإرسال)

 ...
 */
export const JOB_TYPES = ['AI_EVALUATE_SUBMISSION', 'AI_BATCH_COLLECT', 'AI_TEACHER_INSIGHTS', 'AI_GENERATE_EXERCISES', 'AI_GENERATE_QUIZ', 'AI_IMPORT_FILES', 'AI_ANALYZE_STUDENT', 'REPORT_EXPORT', 'CLEANUP', 'PUSH_DISPATCH'] as const

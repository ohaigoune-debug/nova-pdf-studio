...
const en: DeepPartial<typeof ar> = {
  ...
  public: {
    ...
    trust2: 'Works on your phone offline',
    trust3: 'Videos stay on YouTube — nothing to download',
    howTitle: 'How do you start?',
    howSubtitle: 'Three steps, and nothing more than your phone.',
    step1: 'Create your account',
    step1d: 'Your name, email and wilaya — one minute.',
    step2: 'Enter your teacher’s code',
    step2d: 'Your teacher gives you a code that joins you to the group instantly.',
    step3: 'Follow your lessons and attendance',
